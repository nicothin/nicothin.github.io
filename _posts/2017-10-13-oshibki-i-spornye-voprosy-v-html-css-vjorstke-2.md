...
Как разумно заметил в комментарии к [первой части этой статьи]({{ site.url }}/page/oshibki-i-spornye-voprosy-v-html-css-vjorstke) Игорь Тимохин, микроразметка ([Schema.org](http://schema.org/docs/documents.html), [OpenGraph](http://ogp.me/)) — это не сложно и очень полезно для SEO.
...
Читать далее: [Ошибки и спорные моменты стилизации]({{ site.url }}/page/oshibki-i-spornye-voprosy-v-html-css-vjorstke-3)
