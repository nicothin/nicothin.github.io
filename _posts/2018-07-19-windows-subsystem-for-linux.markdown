...
[![bash-терминал сразу после установки](http://nicothin.pro/uploads/web-dev/bash001.png)](http://nicothin.pro/uploads/web-dev/bash001.png)
...
[![Как добавить вызов Sublime Text из консоли](http://nicothin.pro/uploads/web-dev/bash-path.png)](http://nicothin.pro/uploads/web-dev/bash-path.png)
...
[![bash-терминал WSL по умолчанию](http://nicothin.pro/uploads/web-dev/bash-colors-01.png)](http://nicothin.pro/uploads/web-dev/bash-colors-01.png)
...
[![bash-терминал WSL после настройки цветов директорий и файлов](http://nicothin.pro/uploads/web-dev/bash-colors-02.png)](http://nicothin.pro/uploads/web-dev/bash-colors-02.png)
...
[![bash-терминал внутри cmder](http://nicothin.pro/uploads/web-dev/bash-result.png)](http://nicothin.pro/uploads/web-dev/bash-result.png)
...
[![Запуск bash-терминала командой bash в cmd.exe](http://nicothin.pro/uploads/web-dev/bash-winbuntu.png)](http://nicothin.pro/uploads/web-dev/bash-winbuntu.png)
